...
final class SecondPageViewController: UIViewController {
  ...
  private lazy var imageView: UIImageView = {
    let image = Asset.CustomImages.secondPageImage.image
  ...
  private lazy var headerTitle: UILabel = {
    let label = UILabel()
    label.text = L10n.Localizable.Label.secondPageCollectTitle
  ...
  private lazy var textLabel: UILabel = {
    let label = UILabel()
    label.text = L10n.Localizable.Label.secondPageTitle
